...
const uint8_t F_EMOJI = 1;
const uint8_t W_EMOJI = 8;
const uint8_t PROGMEM emoji[F_EMOJI * W_EMOJI] =  // smile emoji
{
 0x00, 0x66, 0x46, 0x40, 0x40, 0x46, 0x66, 0x00
};
...
void startDisplay() {
  ...
  myDisplay.displayText("Neue Grafik", PA_CENTER, 100, PAUSE_TIME, PA_SPRITE, PA_SPRITE);
