...
// Sprite Definitions
const uint8_t F_EMOJI = 2;
const uint8_t W_EMOJI = 8;
const uint8_t PROGMEM emoji[F_EMOJI * W_EMOJI] =  // emoji
{
  0x00, 0x76, 0x46, 0x40, 0x40, 0x46, 0x76, 0x00,
  0x00, 0x76, 0x46, 0x60, 0x60, 0x46, 0x76, 0x00,
};
...
void startDisplay() {
  ...
  myDisplay.displayText("Loading...", PA_CENTER, 100, PAUSE_TIME, PA_SCROLL_LEFT, PA_SCROLL_LEFT);
}
...
void changeDisplay(String whichsprite) {
  ...
  if (whichsprite == "rocket") {
    ...
    myDisplay.displayText(message, PA_CENTER, 100, PAUSE_TIME, PA_SPRITE, PA_SPRITE);
  }
   ...
   else if (whichsprite == "ledtext") {
    myDisplay.displayText(message, PA_CENTER, 100, PAUSE_TIME, PA_SCROLL_LEFT, PA_SCROLL_LEFT);
  }
}
